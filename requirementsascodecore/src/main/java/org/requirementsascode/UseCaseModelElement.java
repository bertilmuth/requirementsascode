...
/**
 * Abstract base class for elements of a use case model. The main purpose of this class is to create
 * named model elements, and make them part of a use case model.
 *
 * @author b_muth
 */
