...
public class FlowStepPart {
    ...
    FlowStepPart(FlowStep useCaseStep, UseCasePart useCasePart, FlowPart useCaseFlowPart) {
    ...
    /**
     * Makes the use case model runner continue at the specified step. No
     * alternative flow starting at the specified step is entered, even if its
     * condition is enabled.
     *
     * @param stepName
     *            name of the step to continue at, in this use case.
